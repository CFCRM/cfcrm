...
class HlOtherDetailsForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['inward_cheque_return'] = forms.ChoiceField(choices = ((None,'--Yes Or No --'),(True,'Yes'),(False,'No')))
        self.fields['multiple_inquiry'] = forms.ChoiceField(choices = ((None,'--Yes Or No --'),(True,'Yes'),(False,'No')))
        for field in self.fields:
            self.fields[field].widget.attrs.update({'class': 'form-control'})
...
class HlPropertyForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['property_type'].queryset = PropertyType.objects.filter(Q(ineffective_date__gte=datetime.now()) | Q(ineffective_date=None))
        self.fields['stage_of_construction'].queryset = StageOfConstruction.objects.filter(Q(ineffective_date__gte=datetime.now()) | Q(ineffective_date=None))
        self.fields['builder_category'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        self.fields['occupation_certificate'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        self.fields['cc_municipal_plan_tax_receipt'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        self.fields['subvention_scheme'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        self.fields['previous_aggrement_available'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        self.fields['apf'] = forms.ChoiceField(choices=((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        for field in self.fields:
            self.fields[field].widget.attrs.update({'class': 'form-control'})
...
class HlLoan_To_Value_Type_1Form(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['loan_amount'] = ModelChoiceField(queryset = LoanAmount.objects.filter(Q(ineffective_date__gte=datetime.now()) | Q(ineffective_date=None)))
        self.fields['car_parking'] = forms.ChoiceField(choices = ((None,'--Yes Or No--'),(True,'Yes'),(False,'No')))
        for field in self.fields:
            self.fields[field].widget.attrs.update({'class': 'form-control'})
        self.fields['loan_amount'].queryset = LoanAmount.objects.filter(Q(ineffective_date__gte=datetime.now()) | Q(ineffective_date=None))
...
class HlIncomeForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['rent_income']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
        self.fields['bank_reflection']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
        self.fields['co_applicant_no_income_only_rent_income']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
        self.fields['co_applicant_mandatory']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
        self.fields['incentive']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
        self.fields['income_foir_incentive']=forms.ChoiceField(choices =
        ((None, '-- Yes Or No --'),
        (True, 'Yes'),
        (False, 'No')),
        )
