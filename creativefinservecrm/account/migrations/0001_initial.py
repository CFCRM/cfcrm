    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deduction_choice', models.CharField(blank=True, choices=[(True, 'Yes'), (False, 'No')], max_length=3, null=True)),
                ...
                ('bonusType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.bonustype')),
                ('deduction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='master.deductiontype')),
                ('incentives_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='master.incentivestype')),
