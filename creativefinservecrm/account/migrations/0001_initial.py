# Generated by Django 3.1.7 on 2022-01-17 18:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('master', '0004_areain_areatype_bonustype_cibiltype_country_deductiontype_defaultyear_incentivestype_lawyertype_rela'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inc_holder', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('prop_owner', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc_available', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('oc_rec', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('oc_rec_floor', models.IntegerField()),
                ('municipal_approved', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.CharField(max_length=10)),
                ('previous_aggrement_available', models.BooleanField(blank=True, choices=[(True, 'Yes'), (False, 'No')], null=True)),
                ('registration_done_previous_aggremnet', models.CharField(max_length=100)),
                ('concern_area', models.CharField(max_length=100)),
                ('stamp_duty_registration_paid', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('stamp_duty_amt', models.IntegerField()),
                ('property_tax_paid', models.BooleanField(blank=True, choices=[(True, 'Yes'), (False, 'No')], null=True)),
                ('society_informed', models.BooleanField(blank=True, choices=[(True, 'Yes'), (False, 'No')], null=True)),
                ('car_parking_amt', models.IntegerField()),
                ('car_parking', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market_val', models.IntegerField()),
                ('prop_loc', models.CharField(max_length=50)),
                ('cc_rec', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('oc_rec', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('municipal_approved', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('area_size', models.IntegerField()),
                ('pay_till_date', models.CharField(max_length=10)),
                ('stamp_duty', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('future_rent', models.IntegerField()),
                ('car_parking_amt', models.IntegerField()),
                ('subvention_scheme', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('car_parking', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('agreement_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.agreementtype')),
                ('apf_approved_lender', models.ManyToManyField(to='master.BankName')),
                ('area_in', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.areain')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_taken', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ...
                ('additional_details_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.additionaldetails')),
                ('cibil_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.cibiltype')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='master.country')),
                ('default_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.defaultyear')),
                ...
                ('nationality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.nationality')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.product')),
                ('profession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.profession')),
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.qualification')),
                ('repayment_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.repaymenthistory')),
            ],
        ),
        migrations.CreateModel(
            name='Investments',
